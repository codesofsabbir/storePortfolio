...
const capitalizedTitle = matchedKey ? pathTitleMap[matchedKey] : "Admin";
  return (
    <div className="absolute top-0 left-0 w-full h-20 flex justify-between items-center boxBg z-50 overflow-hidden">
      <div className="w-20 h-full flex justify-center items-center subBoxBg titleText">
        <Hamburger
          id="mobileNavBarIcon"
