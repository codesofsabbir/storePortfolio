          ...
          <form className="p-5 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              >
                ...
                <option value="Redesign and Updates">
                  Redesign and Updates
                </option>
                <option value="Microsoft Office Services">
            ...
            <button className="py-3 px-5 activeBg text-[#20202a] text-[11px] font-semibold cursor-pointer w-fit rounded ">
              SEND
            </button>
          </form>
        </div>
